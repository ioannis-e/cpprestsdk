...
public:
    ...
    /// <returns>A <c>utility::map&lt;utility::string_t, utility::string_t&gt;</c> containing the key-value components of
    /// the query.</returns>
    _ASYNCRTIMP static utility::map<utility::string_t, utility::string_t> __cdecl split_query(
