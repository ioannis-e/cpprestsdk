...
public:
    ...
    const utility::map<utility::string_t, utility::string_t>& additional_parameters() const
    {
...
private:
    ...
    _ASYNCRTIMP static utility::vector<unsigned char> __cdecl _hmac_sha1(const utility::string_t& key,
