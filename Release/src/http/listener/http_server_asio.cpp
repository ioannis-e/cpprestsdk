...
private:
    ...
    utility::unordered_map<http_listener_impl*, utility::unique_ptr<pplx::extensibility::reader_writer_lock_t>>
...
private:
    ...
    utility::map<std::string, http_listener_impl*> m_listeners;
    pplx::extensibility::reader_writer_lock_t m_listeners_lock;
...
private:
    ...
    asio_server_connection(utility::unique_ptr<boost::asio::ip::tcp::socket> socket,
...
public:
    ...
    static refcount_ptr create(utility::unique_ptr<boost::asio::ip::tcp::socket> socket,
                               http_linux_server* server,
                               hostport_listener* parent)
    {
...
{
    auto thisRequest = http_request::_create_request(utility::make_unique<linux_request_context>());
                ...
                found_hostport_listener =
                    m_listeners
                        .insert(std::make_pair(
                            hostport,
                            utility::make_unique<hostport_listener>(this, hostport, is_https, listener->configuration())))
                        .first;
...
namespace details
{
utility::unique_ptr<http_server> make_http_asio_server() { return utility::make_unique<http_linux_server>(); }
